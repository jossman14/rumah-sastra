...
class QuizPlayFullHasil extends StatefulWidget {
  final String quizId, quizName, description;
  final int correct, incorrect, total;
  QuizPlayFullHasil(this.quizId, this.quizName, this.description, this.correct,
      this.incorrect, this.total);

  @override
  _QuizPlayFullHasilState createState() => _QuizPlayFullHasilState();
}
...
class _QuizPlayFullHasilState extends State<QuizPlayFullHasil> {
  ...
  Widget build(BuildContext context) {
    ...
    quizResult = provider.quizResult;
    return Scaffold(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: OptionTileBackupCek(
                    ...
                    correctAnswer: quizResult.correctAnswer[widget.index],
                    optionSelected: quizResult.optionSelected[widget.index],
                    cekJawaban: quizResult.cekJawaban[widget.index],
                  ),
                ),
                SizedBox(
                  height: 4,
